<?php
$domain = 'http://192.168.100.2/aprilia-trans.web.id/';
$domain = 'https://aprilia-trans.web.id/';
...
<head>
  ...
  <link rel="preload" href="./src/font/inter.ttf" as="font" type="font/ttf" crossorigin>
  <link rel="preload" href="./src/font/poppins-bold.ttf" as="font" type="font/ttf" crossorigin>
      ...
      <div class="max-w-6xl mx-auto px-6">
        <div class="flex justify-between items-center h-20">
          ...
          <div class="lg:hidden flex items-center">
            <button aria-label="Navbar Toggle" name="Navbar Toggle" title="Navbar Toggle" id="mobile-menu-button" class="text-slate-600 hover:text-primary focus:outline-none">
              <i class="fa-solid fa-bars-staggered text-2xl"></i>
              <span class="hidden">Navbar Toggle</span>
            </button>
          </div>
        </div>
      </div>
      ...
      <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
        <div>
          <h1 class="text-4xl md:text-5xl font-bold leading-tight mb-6">
            Travel Tuban Murah dan Satset — <br><span class="text-primary"><?= $brand ?></span>
          </h1>
      ...
      <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div class="grid grid-cols-2 gap-6">
            <div>
              <b class="text-2xl font-bold text-primary">2018</b>
              <p class="text-slate-500 text-sm">Beroperasi Sejak</p>
            </div>
            <div>
              <b class="text-2xl font-bold text-primary"><?= explode(',', $alamat)[0] ?></b>
  ...
  <footer class="bg-slate-900 text-white py-12 px-6">
    <div class=" max-w-6xl mx-auto grid md:grid-cols-3 gap-10 items-center text-center md:text-left">
      ...
      <div class="flex flex-col gap-2">
        ...
        <a name="Whatsapp" title="Whatsapp" aria-label="Whatsapp" href="<?= $whatsapp ?>" target="_blank" rel="nofollow noreferrer"
      ...
      <div class="col-span-full ">
        ...
        <p class="text-slate-400 text-sm mb-3"><?= $alamat ?></p>
